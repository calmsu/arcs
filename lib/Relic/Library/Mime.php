...
/**
 * Require the Relic constants and startup checks.
 */
...
class Mime {
    ...
    /**
     * Translation table of extensions and MIME types.
     */
     ...
     * @return string
     */
    public static function _mime($path) {
     ...
     * @return string
     */
    public static function mime($path, $options=array()) {
    ...
    /**
     * Returns an array of extensions that match the given MIME.
     *
     * @param  string mime
     * @return array
     */
    ...
    /**
     * Print the result of `mime`, passing any options on, and converting 
     * NULL to 'unknown'.
     *
     * @param  string $path
     * @param  array $options
     * @return void
     */
    public static function printMime($path, $options=array()) {
        $mime = self::mime($path, $options=array());
        printf("%s\n", is_null($mime) ? 'unknown' : $mime);
    }
}
