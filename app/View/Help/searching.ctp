...
<p>Facets are a very powerful method of data mining based on searching by data attribute but the general idea is that you’re filtering resources based on the data we store about them.</p>
<p>Facets work by typing in the attribute you would like to filter the resources by, which can be anything as general as the type of resource to something as specific as a title or you can chain them up together. 
For example, you know that John Doe uploaded an image, and you know that he uploaded it yesterday, but you do not know anything else. You can construct a search query that will find everything that John uploaded yesterday.</p>
<p><img alt="searching" src="../img/docs/searching.png" /></p>
<blockquote>
<p>Searching is still in development to include more general searching, but in the meantime, you can find a list of available facets below.</p>
</blockquote>
