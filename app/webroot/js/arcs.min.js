 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 * ======================================================== */!function(a){"use strict";var b=function(b){this.element=a(b)};b.prototype={constructor:b,show:function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.attr("data-target")||b.attr("href"),e,f;if(b.parent("li").hasClass("active"))return;e=c.find(".active a").last()[0],b.trigger({type:"show",relatedTarget:e}),f=a(d),this.activate(b.parent("li"),c),this.activate(f,f.parent(),function(){b.trigger({type:"shown",relatedTarget:e})})},activate:function(b,c,d){function g(){e.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"),b.addClass("active"),f?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active"),d&&d()}var e=c.find("> .active"),f=d&&a.support.transition&&e.hasClass("fade");f?e.one(a.support.transition.end,g):g(),e.removeClass("in")}},a.fn.tab=function(c){return this.each(function(){var d=a(this),e=d.data("tab");e||d.data("tab",e=new b(this)),typeof c=="string"&&e[c]()})},a.fn.tab.Constructor=b,a(function(){a("body").on("click.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(b){b.preventDefault(),a(this).tab("show")})})}(window.jQuery);(function(a,b,c){b.fn.touchwipe=function(a){var c={min_move_x:20,min_move_y:20,wipeLeft:function(){},wipeRight:function(){},wipeUp:function(){},wipeDown:function(){},preventDefaultEvents:!0};return a&&b.extend(c,a),this.each(function(){function e(){this.removeEventListener("touchmove",f),a=null,d=!1}function f(f){c.preventDefaultEvents&&f.preventDefault();if(d){var g=f.touches[0].pageX,h=f.touches[0].pageY,i=a-g,j=b-h;Math.abs(i)>=c.min_move_x?(e(),i>0?c.wipeLeft():c.wipeRight()):Math.abs(j)>=c.min_move_y&&(e(),j>0?c.wipeDown():c.wipeUp())}}function g(c){c.touches.length==1&&(a=c.touches[0].pageX,b=c.touches[0].pageY,d=!0,this.addEventListener("touchmove",f,!1))}var a,b,d=!1;"ontouchstart"in document.documentElement&&this.addEventListener("touchstart",g,!1)}),this},b.elastislide=function(a,c){this.$el=b(c),this._init(a)},b.elastislide.defaults={speed:450,easing:"",imageW:190,margin:3,border:2,minItems:1,current:0,onClick:function(){return!1}},b.elastislide.prototype={_init:function(a){this.options=b.extend(!0,{},b.elastislide.defaults,a),this.$slider=this.$el.find("ul"),this.$items=this.$slider.children("li"),this.itemsCount=this.$items.length,this.$esCarousel=this.$slider.parent(),this._validateOptions(),this._configure(),this._addControls(),this._initEvents(),this.$slider.show(),this._slideToCurrent(!1)},_validateOptions:function(){this.options.speed<0&&(this.options.speed=450),this.options.margin<0&&(this.options.margin=4),this.options.border<0&&(this.options.border=1);if(this.options.minItems<1||this.options.minItems>this.itemsCount)this.options.minItems=1;this.options.current>this.itemsCount-1&&(this.options.current=0)},_configure:function(){this.current=this.options.current,this.visibleWidth=this.$esCarousel.width(),this.visibleWidth<this.options.minItems*(this.options.imageW+2*this.options.border)+(this.options.minItems-1)*this.options.margin?(this._setDim((this.visibleWidth-(this.options.minItems-1)*this.options.margin)/this.options.minItems),this._setCurrentValues(),this.fitCount=this.options.minItems):(this._setDim(),this._setCurrentValues()),this.$slider.css({width:this.sliderW})},_setDim:function(a){this.$items.css({marginRight:this.options.margin,width:a?a:this.options.imageW+2*this.options.border}).children("a").css({borderWidth:this.options.border})},_setCurrentValues:function(){this.itemW=this.$items.outerWidth(!0),this.sliderW=this.itemW*this.itemsCount,this.visibleWidth=this.$esCarousel.width(),this.fitCount=Math.floor(this.visibleWidth/this.itemW)},_addControls:function(){this.$navNext=b('<span class="es-nav-next">Next</span>'),this.$navPrev=b('<span class="es-nav-prev">Previous</span>'),b('<div class="es-nav"/>').append(this.$navPrev).append(this.$navNext).appendTo(this.$el)},_toggleControls:function(a,b){a&&b?b===1?a==="right"?this.$navNext.show():this.$navPrev.show():a==="right"?this.$navNext.hide():this.$navPrev.hide():(this.current===this.itemsCount-1||this.fitCount>=this.itemsCount)&&this.$navNext.hide()},_initEvents:function(){var c=this;b(a).bind("resize.elastislide",function(a){c._reload(),clearTimeout(c.resetTimeout),c.resetTimeout=setTimeout(function(){c._slideToCurrent()},200)}),this.$navNext.bind("click.elastislide",function(a){b(".overlay").addClass("hidden"),c._slide("right"),b(".overlay").removeClass("hidden")}),this.$navPrev.bind("click.elastislide",function(a){b(".overlay").addClass("hidden"),c._slide("left"),b(".overlay").removeClass("hidden")}),this.$items.bind("click.elastislide",function(a){return c.options.onClick(b(this)),!1}),c.$slider.touchwipe({wipeLeft:function(){b(".overlay").addClass("hidden"),c._slide("right"),b(".overlay").removeClass("hidden")},wipeRight:function(){b(".overlay").addClass("hidden"),c._slide("left"),b(".overlay").removeClass("hidden")}})},reload:function(a){this._reload(),a&&a.call()},_reload:function(){var a=this;a._setCurrentValues(),a.visibleWidth<a.options.minItems*(a.options.imageW+2*a.options.border)+(a.options.minItems-1)*a.options.margin?(a._setDim((a.visibleWidth-(a.options.minItems-1)*a.options.margin)/a.options.minItems),a._setCurrentValues(),a.fitCount=a.options.minItems):(a._setDim(),a._setCurrentValues()),a.$slider.css({width:a.sliderW+10})},_slide:function(a,d,e,f){var g=parseFloat(this.$slider.css("margin-left"));if(d===c){var h=this.fitCount*this.itemW,d;if(h<0)return!1;if(a==="right"&&this.sliderW-(Math.abs(g)+h)<this.visibleWidth)h=this.sliderW-(Math.abs(g)+this.visibleWidth)-this.options.margin,this._toggleControls("right",-1),this._toggleControls("left",1);else if(a==="left"&&Math.abs(g)-h<0)h=Math.abs(g),this._toggleControls("left",-1),this._toggleControls("right",1);else{var i;a==="right"?i=Math.abs(g)+this.options.margin+Math.abs(h):i=Math.abs(g)-this.options.margin-Math.abs(h),i>0?this._toggleControls("left",1):this._toggleControls("left",-1),i<this.sliderW-this.visibleWidth?this._toggleControls("right",1):this._toggleControls("right",-1)}a==="right"?d="-="+h:d="+="+h}else{var i=Math.abs(d);Math.max(this.sliderW,this.visibleWidth)-i<this.visibleWidth&&(d=-(Math.max(this.sliderW,this.visibleWidth)-this.visibleWidth),d!==0&&(d+=this.options.margin),this._toggleControls("right",-1),i=Math.abs(d)),i>0?this._toggleControls("left",1):this._toggleControls("left",-1),Math.max(this.sliderW,this.visibleWidth)-this.visibleWidth>i+this.options.margin?this._toggleControls("right",1):this._toggleControls("right",-1)}b.fn.applyStyle=e===c?b.fn.animate:b.fn.css;var j={marginLeft:d},k=this;this.$slider.stop().applyStyle(j,b.extend(!0,[],{duration:this.options.speed,easing:this.options.easing,complete:function(){f&&f.call()}}))},_slideToCurrent:function(a){var b=this.current*this.itemW;this._slide("",-b,a)},slideToIndex:function(a){var b=a*this.itemW;this._slide("",-b,!1)},add:function(a,b){this.$items=this.$items.add(a),this.itemsCount=this.$items.length,this._setDim(),this._setCurrentValues(),this.$slider.css({width:this.sliderW}),this._slideToCurrent(),b&&b.call(a)},setCurrent:function(a,b){this.current=a;var c=Math.abs(parseFloat(this.$slider.css("margin-left"))),d=c+this.visibleWidth,e=Math.abs(this.current*this.itemW);(e+this.itemW>d||e<c)&&this._slideToCurrent(),b&&b.call()},destroy:function(a){this._destroy(a)},_destroy:function(c){this.$el.unbind(".elastislide").removeData("elastislide"),b(a).unbind(".elastislide"),c&&c.call()}};var d=function(a){this.console&&console.error(a)};b.fn.elastislide=function(a){if(typeof a=="string"){var c=Array.prototype.slice.call(arguments,1);this.each(function(){var e=b.data(this,"elastislide");if(!e)return;if(!b.isFunction(e[a])||a.charAt(0)==="_"){d("no such method '"+a+"' for elastislide instance");return}e[a].apply(e,c)})}else this.each(function(){var c=b.data(this,"elastislide");c||b.data(this,"elastislide",new b.elastislide(a,this))});return this}})(window,jQuery);(function(a){function f(){return a("<div/>")}var b=Math.abs,c=Math.max,d=Math.min,e=Math.round;a.imgAreaSelect=function(g,h){function X(a){return a+s.left-w.left}function Y(a){return a+s.top-w.top}function Z(a){return a-s.left+w.left}function _(a){return a-s.top+w.top}function ba(a){return a.pageX-w.left}function bb(a){return a.pageY-w.top}function bc(a){var b=a||B,c=a||C;return{x1:e(O.x1*b),y1:e(O.y1*c),x2:e(O.x2*b),y2:e(O.y2*c),width:e(O.x2*b)-e(O.x1*b),height:e(O.y2*c)-e(O.y1*c)}}function bd(a,b,c,d,f){var g=f||B,h=f||C;O={x1:e(a/g||0),y1:e(b/h||0),x2:e(c/g||0),y2:e(d/h||0)},O.width=O.x2-O.x1,O.height=O.y2-O.y1}function be(){if(!i.width())return;s={left:e(i.offset().left),top:e(i.offset().top)},t=i.innerWidth(),u=i.innerHeight(),s.top+=i.outerHeight()-u>>1,s.left+=i.outerWidth()-t>>1,E=e(h.minWidth/B)||0,F=e(h.minHeight/C)||0,G=e(d(h.maxWidth/B||1<<24,t)),H=e(d(h.maxHeight/C||1<<24,u)),a().jquery=="1.3.2"&&y=="fixed"&&!P.getBoundingClientRect&&(s.top+=c(document.body.scrollTop,P.scrollTop),s.left+=c(document.body.scrollLeft,P.scrollLeft)),w=/absolute|relative/.test(v.css("position"))?{left:e(v.offset().left)-v.scrollLeft(),top:e(v.offset().top)-v.scrollTop()}:y=="fixed"?{left:a(document).scrollLeft(),top:a(document).scrollTop()}:{left:0,top:0},q=X(0),r=Y(0),(O.x2>t||O.y2>u)&&bm()}function bf(b){if(!J)return;k.css({left:X(O.x1),top:Y(O.y1)}).add(l).width(U=O.width).height(V=O.height),l.add(m).add(o).css({left:0,top:0}),m.width(c(U-m.outerWidth()+m.innerWidth(),0)).height(c(V-m.outerHeight()+m.innerHeight(),0)),a(n[0]).css({left:q,top:r,width:O.x1,height:u}),a(n[1]).css({left:q+O.x1,top:r,width:U,height:O.y1}),a(n[2]).css({left:q+O.x2,top:r,width:t-O.x2,height:u}),a(n[3]).css({left:q+O.x1,top:r+O.y2,width:U,height:u-O.y2}),U-=o.outerWidth(),V-=o.outerHeight();switch(o.length){case 8:a(o[4]).css({left:U>>1}),a(o[5]).css({left:U,top:V>>1}),a(o[6]).css({left:U>>1,top:V}),a(o[7]).css({top:V>>1});case 4:o.slice(1,3).css({left:U}),o.slice(2,4).css({top:V})}b!==!1&&(a.imgAreaSelect.keyPress!=bv&&a(document).unbind(a.imgAreaSelect.keyPress,a.imgAreaSelect.onKeyPress),h.keys&&a(document)[a.imgAreaSelect.keyPress](a.imgAreaSelect.onKeyPress=bv)),a.browser.msie&&m.outerWidth()-m.innerWidth()==2&&(m.css("margin",0),setTimeout(function(){m.css("margin","auto")},0))}function bg(a){be(),bf(a),K=X(O.x1),L=Y(O.y1),M=X(O.x2),N=Y(O.y2)}function bh(a,b){h.fadeSpeed?a.fadeOut(h.fadeSpeed,b):a.hide()}function bi(a){var b=Z(ba(a))-O.x1,c=_(bb(a))-O.y1;W||(be(),W=!0,k.one("mouseout",function(){W=!1})),D="",h.resizable&&(c<=h.resizeMargin?D="n":c>=O.height-h.resizeMargin&&(D="s"),b<=h.resizeMargin?D+="w":b>=O.width-h.resizeMargin&&(D+="e")),k.css("cursor",D?D+"-resize":h.movable?"move":""),p&&p.toggle()}function bj(b){a("body").css("cursor",""),(h.autoHide||O.width*O.height==0)&&bh(k.add(n),function(){a(this).hide()}),a(document).unbind("mousemove",bn),k.mousemove(bi),h.onSelectEnd(g,bc())}function bk(b){return b.which!=1?!1:(be(),D?(a("body").css("cursor",D+"-resize"),K=X(O[/w/.test(D)?"x2":"x1"]),L=Y(O[/n/.test(D)?"y2":"y1"]),a(document).mousemove(bn).one("mouseup",bj),k.unbind("mousemove",bi)):h.movable?(z=q+O.x1-ba(b),A=r+O.y1-bb(b),k.unbind("mousemove",bi),a(document).mousemove(bp).one("mouseup",function(){h.onSelectEnd(g,bc()),a(document).unbind("mousemove",bp),k.mousemove(bi)})):i.mousedown(b),!1)}function bl(a){I&&(a?(M=c(q,d(q+t,K+b(N-L)*I*(M>K||-1))),N=e(c(r,d(r+u,L+b(M-K)/I*(N>L||-1)))),M=e(M)):(N=c(r,d(r+u,L+b(M-K)/I*(N>L||-1))),M=e(c(q,d(q+t,K+b(N-L)*I*(M>K||-1)))),N=e(N)))}function bm(){K=d(K,q+t),L=d(L,r+u),b(M-K)<E&&(M=K-E*(M<K||-1),M<q?K=q+E:M>q+t&&(K=q+t-E)),b(N-L)<F&&(N=L-F*(N<L||-1),N<r?L=r+F:N>r+u&&(L=r+u-F)),M=c(q,d(M,q+t)),N=c(r,d(N,r+u)),bl(b(M-K)<b(N-L)*I),b(M-K)>G&&(M=K-G*(M<K||-1),bl()),b(N-L)>H&&(N=L-H*(N<L||-1),bl(!0)),O={x1:Z(d(K,M)),x2:Z(c(K,M)),y1:_(d(L,N)),y2:_(c(L,N)),width:b(M-K),height:b(N-L)},bf(),h.onSelectChange(g,bc())}function bn(a){return M=/w|e|^$/.test(D)||I?ba(a):X(O.x2),N=/n|s|^$/.test(D)||I?bb(a):Y(O.y2),bm(),!1}function bo(b,c){M=(K=b)+O.width,N=(L=c)+O.height,a.extend(O,{x1:Z(K),y1:_(L),x2:Z(M),y2:_(N)}),bf(),h.onSelectChange(g,bc())}function bp(a){return K=c(q,d(z+ba(a),q+t-O.width)),L=c(r,d(A+bb(a),r+u-O.height)),bo(K,L),a.preventDefault(),!1}function bq(){a(document).unbind("mousemove",bq),be(),M=K,N=L,bm(),D="",n.is(":visible")||k.add(n).hide().fadeIn(h.fadeSpeed||0),J=!0,a(document).unbind("mouseup",br).mousemove(bn).one("mouseup",bj),k.unbind("mousemove",bi),h.onSelectStart(g,bc())}function br(){a(document).unbind("mousemove",bq).unbind("mouseup",br),bh(k.add(n)),bd(Z(K),_(L),Z(K),_(L)),!this instanceof a.imgAreaSelect&&(h.onSelectChange(g,bc()),h.onSelectEnd(g,bc()))}function bs(b){return b.which!=1||n.is(":animated")?!1:(be(),z=K=ba(b),A=L=bb(b),a(document).mousemove(bq).mouseup(br),!1)}function bt(){bg(!1)}function bu(){j=!0,bx(h=a.extend({classPrefix:"imgareaselect",movable:!0,parent:"body",resizable:!0,resizeMargin:10,onInit:function(){},onSelectStart:function(){},onSelectChange:function(){},onSelectEnd:function(){}},h)),k.add(n).css({visibility:""}),h.show&&(J=!0,be(),bf(),k.add(n).hide().fadeIn(h.fadeSpeed||0)),setTimeout(function(){h.onInit(g,bc())},0)}function bw(a,b){for(option in b)h[option]!==undefined&&a.css(b[option],h[option])}function bx(b){b.parent&&(v=a(b.parent)).append(k.add(n)),a.extend(h,b),be();if(b.handles!=null){o.remove(),o=a([]),S=b.handles?b.handles=="corners"?4:8:0;while(S--)o=o.add(f());o.addClass(h.classPrefix+"-handle").css({position:"absolute",fontSize:0,zIndex:x+1||1}),!parseInt(o.css("width"))>=0&&o.width(5).height(5),(T=h.borderWidth)&&o.css({borderWidth:T,borderStyle:"solid"}),bw(o,{borderColor1:"border-color",borderColor2:"background-color",borderOpacity:"opacity"})}B=h.imageWidth/t||1,C=h.imageHeight/u||1,b.x1!=null&&(bd(b.x1,b.y1,b.x2,b.y2),b.show=!b.hide),b.keys&&(h.keys=a.extend({shift:1,ctrl:"resize"},b.keys)),n.addClass(h.classPrefix+"-outer"),l.addClass(h.classPrefix+"-selection");for(S=0;S++<4;)a(m[S-1]).addClass(h.classPrefix+"-border"+S);bw(l,{selectionColor:"background-color",selectionOpacity:"opacity"}),bw(m,{borderOpacity:"opacity",borderWidth:"border-width"}),bw(n,{outerColor:"background-color",outerOpacity:"opacity"}),(T=h.borderColor1)&&a(m[0]).css({borderStyle:"solid",borderColor:T}),(T=h.borderColor2)&&a(m[1]).css({borderStyle:"dashed",borderColor:T}),k.append(l.add(m).add(p).add(o)),a.browser.msie&&((T=n.css("filter").match(/opacity=(\d+)/))&&n.css("opacity",T[1]/100),(T=m.css("filter").match(/opacity=(\d+)/))&&m.css("opacity",T[1]/100)),b.hide?bh(k.add(n)):b.show&&j&&(J=!0,k.add(n).fadeIn(h.fadeSpeed||0),bg()),I=(R=(h.aspectRatio||"").split(/:/))[0]/R[1],i.add(n).unbind("mousedown",bs);if(h.disable||h.enable===!1)k.unbind("mousemove",bi).unbind("mousedown",bk),a(window).unbind("resize",bt);else{if(h.enable||h.disable===!1)(h.resizable||h.movable)&&k.mousemove(bi).mousedown(bk),a(window).resize(bt);h.persistent||i.add(n).mousedown(bs)}h.enable=h.disable=undefined}var i=a(g),j,k=f(),l=f(),m=f().add(f()).add(f()).add(f()),n=f().add(f()).add(f()).add(f()),o=a([]),p,q,r,s={left:0,top:0},t,u,v,w={left:0,top:0},x=0,y="absolute",z,A,B,C,D,E,F,G,H,I,J,K,L,M,N,O={x1:0,y1:0,x2:0,y2:0,width:0,height:0},P=document.documentElement,Q,R,S,T,U,V,W,bv=function(a){var b=h.keys,e,f,g=a.keyCode;e=!isNaN(b.alt)&&(a.altKey||a.originalEvent.altKey)?b.alt:!isNaN(b.ctrl)&&a.ctrlKey?b.ctrl:!isNaN(b.shift)&&a.shiftKey?b.shift:isNaN(b.arrows)?10:b.arrows;if(b.arrows=="resize"||b.shift=="resize"&&a.shiftKey||b.ctrl=="resize"&&a.ctrlKey||b.alt=="resize"&&(a.altKey||a.originalEvent.altKey)){switch(g){case 37:e=-e;case 39:f=c(K,M),K=d(K,M),M=c(f+e,K),bl();break;case 38:e=-e;case 40:f=c(L,N),L=d(L,N),N=c(f+e,L),bl(!0);break;default:return}bm()}else{K=d(K,M),L=d(L,N);switch(g){case 37:bo(c(K-e,q),L);break;case 38:bo(K,c(L-e,r));break;case 39:bo(K+d(e,t-Z(M)),L);break;case 40:bo(K,L+d(e,u-_(N)));break;default:return}}return!1};this.remove=function(){bx({disable:!0}),k.add(n).remove()},this.getOptions=function(){return h},this.setOptions=bx,this.getSelection=bc,this.setSelection=bd,this.cancelSelection=br,this.update=bg,Q=i;while(Q.length)x=c(x,isNaN(Q.css("z-index"))?x:Q.css("z-index")),Q.css("position")=="fixed"&&(y="fixed"),Q=Q.parent(":not(body)");x=h.zIndex||x,a.browser.msie&&i.attr("unselectable","on"),a.imgAreaSelect.keyPress=a.browser.msie||a.browser.safari?"keydown":"keypress",a.browser.opera&&(p=f().css({width:"100%",height:"100%",position:"absolute",zIndex:x+2||2})),k.add(n).css({visibility:"hidden",position:y,overflow:"hidden",zIndex:x||"0"}),k.css({zIndex:x+2||2}),l.add(m).css({position:"absolute",fontSize:0}),g.complete||g.readyState=="complete"||!i.is("img")?bu():i.one("load",bu),a.browser.msie&&a.browser.version>=7&&(g.src=g.src)},a.fn.imgAreaSelect=function(b){return b=b||{},this.each(function(){a(this).data("imgAreaSelect")?b.remove?(a(this).data("imgAreaSelect").remove(),a(this).removeData("imgAreaSelect")):a(this).data("imgAreaSelect").setOptions(b):b.remove||(b.enable===undefined&&b.disable===undefined&&(b.enable=!0),a(this).data("imgAreaSelect",new a.imgAreaSelect(this,b)))}),b.instance?a(this).data("imgAreaSelect"):this}})(jQuery);var relativeDate=function(a){function j(b,c){!c&&(c=(new Date).getTime()),c instanceof Date&&(c=c.getTime()),b instanceof Date&&(b=b.getTime());var d=c-b,e,f,g;for(f=-1,g=i.length;++f<g;){e=i[f];if(d<e[0])return e[2]==a?e[1]:Math.round(d/e[2])+" "+e[1]}}var b=1e3,c=60*b,d=60*c,e=24*d,f=7*e,g=e*365,h=g/12,i=[[.7*c,"just now"],[1.5*c,"a minute ago"],[60*c,"minutes ago",c],[1.5*d,"an hour ago"],[e,"hours ago",d],[2*e,"yesterday"],[7*e,"days ago",e],[1.5*f,"a week ago"],[h,"weeks ago",f],[1.5*h,"a month ago"],[g,"months ago",h],[1.5*g,"a year ago"],[Number.MAX_VALUE,"years ago",g]];return j}();typeof module!="undefined"&&module.exports&&(module.exports=relativeDate);window.arcs={},arcs.views={},arcs.models={},arcs.collections={},arcs.events={},arcs.utils={},_.extend(arcs,Backbone.Events);var _sync,__slice=Array.prototype.slice;arcs.debug=!0,arcs.version="v0.1",arcs.baseURL="/",document.location.href.match(/:8080\/~[a-z0-9]+\//)&&(arcs.baseURL+=document.location.href.match(/~[a-z0-9]+\//),arcs.baseURL+="arcs/"),arcs.focusHelper=function(a){var b;return b=a.val(),a.live("focus",function(){if(a.val()===b)return a.val(""),a.removeClass("unfocused")}),a.live("blur",function(){if(a.val()==="")return a.val(b),a.addClass("unfocused")})},arcs.log=function(){var a;a=1<=arguments.length?__slice.call(arguments,0):[];if(arcs.debug&&(typeof console!=="undefined"&&console!==null?console.log:void 0)!=null)return console.log.apply(console,["[ARCS]:"].concat(__slice.call(a)))},_sync=Backbone.sync,Backbone.sync=function(a,b,c){return arcs.log("Backbone.sync:",a,b,c),_sync(a,b,c)},arcs.startup=function(){var a,b;return a=arcs.debug?"on":"off",b=arcs.debug?"off":"on",console.log("********************************************************"),console.log("[ARCS "+arcs.version+"]: Debug is "+a+".\n"+("To turn it "+b+", set `arcs.debug` to "+!arcs.debug+".")),console.log("********************************************************")},arcs.startup();arcs.templates={},arcs.templates.resourceImage='<img src="{{ url }}" alt="resource" data-id="{{ id }}">',arcs.templates.resourceDocument='<iframe src="http://docs.google.com/gview?url={{ url }}&embedded=true"\n    style="width:60%; height:100%; float:left;" frameborder="0"></iframe>',arcs.templates.resourceTable='<tr>\n    <td>Title</td>\n    <td>{{ title }}\n</tr>\n<tr>\n    <td>Public</td>\n    {{# public }}\n    <td>Yes</td>\n    {{/ public }}\n    {{^ public }}\n    <td>No</td>\n    {{/ public }}\n</tr>\n<tr>\n    <td>Created</td>\n    <td>{{ created }}</td>\n</tr>\n{{# modified }}\n<tr>\n    <td>Modified</td>\n    <td>{{ modified }}</td>\n</tr>\n{{/ modified }}\n<tr>\n    <td>Download Link</td>\n    <td><a href="{{ url }}">{{ file_name }}</a></td>\n</tr>',arcs.templates.collectionTable='<tr>\n    <td>Title</td>\n    <td>{{ title }}\n</tr>\n<tr>\n    <td>Description</td>\n    <td>{{ description }}\n</tr>\n<tr>\n    <td>Public</td>\n    {{# public }}\n    <td>Yes</td>\n    {{/ public }}\n    {{^ public }}\n    <td>No</td>\n    {{/ public }}\n</tr>\n{{# pdf }}\n<tr>\n    <td>Original PDF</td>\n    <td><a href="../resource/{{ pdf }}">Link</a></td>\n</tr>\n{{/ pdf }}',arcs.templates.discussion='{{# comments }}\n<div class="comment-wrapper" id="comment-{{ id }}">\n    <div class="comment-header">\n        <span class="name">{{ name }}{{ _name }}</span>\n        commented \n        <span class="time">{{ created }}{{ _created }}</span>\n    </div>\n    <div class="comment">{{ content }}</div>\n</div>\n{{/ comments }}',arcs.templates.tagList='{{# tags }}\n<a class="tag" id="tag-{{ id }}">\n    {{ tag }}\n</a>\n<br>\n{{/ tags }}',arcs.templates.hotspotModal='<div class="modal-header">\n    <h3>New Annotation</h3>\n</div>\n<div class="modal-body">\n    <h4>Type</h4>\n    <select id="type">\n        <option value="photo">Photo</option>\n    </select>\n    <hr>\n    <h4>Caption</h4>\n    <textarea id="caption"></textarea>\n</div>\n<div class="modal-footer">\n    <button id="cancel" class="btn">Cancel</button>\n    <button id="save" class="btn success">Save</button>\n</div>',arcs.templates.hotspot='{{# hotspots }}\n<a class="hotspot" style="left:{{left}}px; top:{{top}}px; width:{{width}}px;\n    height:{{height}}px;" rel="popover" data-original-title="{{type}}"\n    data-content="{{caption}}" href="{{url}}"></a>\n{{/ hotspots }}',arcs.templates.annotation='{{# hotspots }}\n<a class="annotation">{{ type }}</a>\n<br>\n<span class="annotation-caption">{{ caption}}</span>\n<br>\n{{/ hotspots }}',arcs.templates.button='<a class="btn icon unselectable" id="{{ id }}"\n    {{# url }} href="{{ url }}" {{/ url }}>\n    <span class="{{ class }}"></span>\n    {{ text }}\n</a>',arcs.templates.resultsGrid='{{# results }}\n<div class="result grid">\n    <img src="{{ thumb }}" data-id="{{ id }}" style="height:100px" />\n    <div><strong>{{ title }}</strong></div>\n    <div>{{ user_name }}</div>\n</div>\n{{/ results }}\n{{^ results }}\n<div id="no-results">No Results</div>\n{{/ results }}',arcs.templates.resultsList='<table>\n{{# results }}\n<tr class="result list">\n    <td>\n        <img src="{{ thumb }}" data-id="{{ id }}" style="width:100px" />\n    </td>\n    <td>\n        <div><strong>{{ title }}</strong></div>\n        <br>\n        <div>{{ user_name }}</div>\n    </td>\n</tr>\n{{/ results }}\n</table>\n{{^ results }}\n<div id="no-results">No Results</div>\n{{/ results }}',arcs.templates.modalWrapper='<div id="modal" class="modal" style="display:none"></div>',arcs.templates.searchModal='<div class="modal-header">\n    <h3>{{ title }}</h3>\n</div>\n<div class="modal-body">\n    {{ message }}\n    <br><br>\n    <input type="text" value="{{ value }}" id="search-modal-value" />\n</div>\n<div class="modal-footer">\n    <button id="cancel" class="btn">Cancel</button>\n    <button id="save" class="btn info">Make it so</button>\n</div>';arcs.utils.hash={set:function(a){return this.history.push(document.location.hash),document.location.hash=a},get:function(){return document.location.hash.slice(1)},rewind:function(){return this.set(this.history.pop())},history:[]};var __bind=function(a,b){return function(){return a.apply(b,arguments)}};arcs.utils.keys={initialize:function(){return $(document).bind("keydown",this.delegate)},delegate:__bind(function(a){var b,c,d,e,f,g,h;if(a.target.type==="text"||/textarea|select/i.test(a.target.nodeName))return!0;a.ctrlKey||a.shiftKey||a.altKey||a.metaKey?f=!0:f=!1,e=this.get(a.which,f);if(!e.length)return!0;b=!1;for(g=0,h=e.length;g<h;g++)d=e[g],d.bubble&&(b=!0),d.context?c=_.bind(d.callback,d.context):c=d.callback,c(a);return b?!0:(a.preventDefault(),!1)},this),add:function(a,b,c,d,e){return d==null&&(d=null),e==null&&(e=!1),this.mappings.push({key:a,modifier:b,callback:c,context:d,bubble:e}),this.mappings},get:function(a,b){var c;return b==null&&(b=!1),c=_.filter(this.mappings,__bind(function(c){return c.key===this.humanize(a)&&c.modifier===b},this))},mappings:[],humanize:function(a){return _.has(this.specialKeys,a)?this.specialKeys[a]:String.fromCharCode(a).toLowerCase()},specialKeys:{8:"backspace",9:"tab",13:"return",16:"shift",17:"ctrl",18:"alt",27:"esc",32:"space",37:"left",38:"up",39:"right",40:"down",107:"+",109:"-"}},arcs.utils.keys.initialize();var __indexOf=Array.prototype.indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(this[b]===a)return b;return-1};arcs.utils.mime={imageTypes:{"image/png":"png","image/jpeg":"jpeg","image/jpg":"jpg","image/gif":"gif"},documentTypes:{"application/pdf":"pdf","application/vnd.openxmlformats-officedocument.wordprocessingml.document":"docx","application/msword":"doc","text/plain":"plaintext","text/richtext":"richtext","text/rtf":"rtf"},videoTypes:{"video/mpeg":"mpeg","video/msvideo":"avi","video/quicktime":"mov"},types:function(){return _.keys(this.imageTypes).concat(_.keys(this.documentTypes).concat(_.keys(this.videoTypes)))},getInfo:function(a){var b,c,d,e,f,g,h;e={type:"undefined",ext:null},d={image:this.imageTypes,document:this.documentTypes,video:this.videoTypes},h=_.keys(d);for(f=0,g=h.length;f<g;f++)c=h[f],__indexOf.call(_.keys(d[c]),a)>=0&&(b={type:c,ext:d[c][a]});return b||e}};var __bind=function(a,b){return function(){return a.apply(b,arguments)}};arcs.utils.modal=function(a){var b,c,d,e,f,g;c={template:"",templateValues:{},draggable:!1,backdrop:!0,inputs:[],buttons:{save:{callback:function(a,b){return b.modal("hide")},context:this,closeAfter:!0}}},a=_.extend(c,a),a.buttons.cancel==null&&(a.buttons.cancel={closeAfter:!0}),$("#modal").length||$("body").append(arcs.templates.modalWrapper),b=$("#modal"),b.modal({backdrop:a.backdrop}),b.html(Mustache.render(a.template,a.templateValues)),b.modal("show"),a.draggable&&b.draggable(),g=_.keys(a.buttons);for(e=0,f=g.length;e<f;e++)d=g[e],b.find("#"+d).one("click",__bind(function(c){var d,e,f,g,h,i,j,k,l,m,n,o;h=a.buttons[c.target.id],i={};if(a.inputs.length){l=a.inputs;for(j=0,k=l.length;j<k;j++)g=l[j],i[g]=b.find("#"+g).val()}f=(m=h.context)!=null?m:this,d=(n=h.callback)!=null?n:function(){},e=(o=h.closeAfter)!=null?o:!0,d=_.bind(d,f),d(i,b);if(e)return b.modal("hide")},this));return b};var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.models.Bookmark=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return __extends(b,a),b.prototype.urlRoot=arcs.baseURL+"bookmarks",b}(Backbone.Model);var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.models.Comment=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Model),a.prototype.urlRoot=arcs.baseURL+"comments",a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.models.Hotspot=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Model),a.prototype.urlRoot=arcs.baseURL+"hotspots",a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.models.Resource=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Model),a.prototype.defaults={id:null,mime_type:"image/png",modified:null,created:null,"public":!1},a.prototype.urlRoot=arcs.baseURL+"resources",a.prototype.parse=function(a){if(a.modified=a.created)a.modified=null;return a},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.models.Tag=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Model),a.prototype.urlRoot=arcs.baseURL+"tags",a.prototype.validate=function(a){var b;if(arcs.tagView!=null){b=arcs.tagView.collection.pluck("tag"),b.push(a.tag);if(_.uniq(b).length!==b.length)return arcs.log("non unique")}},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.collections.Collection=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Collection),a.prototype.model=arcs.models.Resource,a.prototype.parse=function(a){var b,c,d;for(c=0,d=a.length;c<d;c++)b=a[c],b.modified===b.created&&(b.modified=null);return a},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.collections.Discussion=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Collection),a.prototype.model=arcs.models.Comment,a.prototype.url=function(){return arcs.baseURL+"resources/comments/"+arcs.resource.id},a.prototype.parse=function(a){var b,c,d;a=function(){var c,d,e;e=[];for(c=0,d=a.length;c<d;c++)b=a[c],e.push(_.extend(b.User,b.Comment));return e}();for(c=0,d=a.length;c<d;c++)b=a[c],b.created=relativeDate(new Date(b.created));return a},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.collections.HotspotMap=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Collection),a.prototype.model=arcs.models.Hotspot,a.prototype.url=function(){return arcs.baseURL+"resources/hotspots/"+arcs.resource.id},a.prototype.parse=function(a){var b,c,d,e;e=[];for(c=0,d=a.length;c<d;c++)b=a[c],e.push(b.Hotspot);return e},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.collections.ResultSet=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Collection),a.prototype.model=arcs.models.Resource,a.prototype.url=function(){return arcs.baseURL+"search/"},a.prototype.parse=function(a){var b,c,d,e,f;c=[];for(e=0,f=a.length;e<f;e++)b=a[e],d=b.User.name,b=b.Resource,b.user_name=d,b.modified===b.created&&(b.modified=null),c.push(b);return c},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.collections.TagList=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.Collection),a.prototype.model=arcs.models.Tag,a.prototype.url=function(){return arcs.baseURL+"resources/tags/"+arcs.resource.id},a.prototype.parse=function(a){var b,c,d,e;e=[];for(c=0,d=a.length;c<d;c++)b=a[c],e.push(b.Tag);return e},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a},__bind=function(a,b){return function(){return a.apply(b,arguments)}};arcs.views.Discussion=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.events={"click #comment-button":"saveComment"},a.prototype.initialize=function(){return this.collection=new arcs.collections.Discussion,arcs.bind("resourceChange",__bind(function(){return this.update()},this)),_.bindAll(this,"render"),this.collection.bind("add",this.render,this),this.collection.bind("remove",this.render,this),this.update()},a.prototype.saveComment=function(){var a,b;return a=this.el.find("textarea#content"),b=new arcs.models.Comment({resource_id:arcs.resource.id,content:a.val(),_name:"You",_created:"just now"}),a.val(""),b.save(),this.collection.add(b)},a.prototype.update=function(){return this.collection.fetch({success:__bind(function(){return this.render()},this)})},a.prototype.render=function(){var a;return a=$("#comment-wrapper"),a.html(Mustache.render(arcs.templates.discussion,{comments:this.collection.toJSON()})),this},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a},__bind=function(a,b){return function(){return a.apply(b,arguments)}};arcs.views.Hotspot=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.initialize=function(){return this.collection=new arcs.collections.HotspotMap,arcs.bind("resourceLoaded",__bind(function(){return this.setup()},this)),this.collection.bind("add",__bind(function(){return this.render()},this)),this.collection.bind("remove",__bind(function(){return this.render()},this))},a.prototype.setup=function(){this.img=this.el.find("img");if(this.img!=null)return this.startImgAreaSelect(),this.update()},a.prototype.startImgAreaSelect=function(a){return a==null&&(a=null),this.img.imgAreaSelect({handles:!0,onSelectEnd:__bind(function(a,b){return this.currentHotspot={img:a,sel:b},this.openModal()},this)})},a.prototype.openModal=function(){return arcs.modal({template:arcs.templates.hotspotModal,draggable:!0,backdrop:!1,inputs:["caption","type"],buttons:{save:{callback:function(a){return this.saveHotspot(a),this.img.imgAreaSelect({hide:!0})},context:this},cancel:{callback:function(){return this.img.imgAreaSelect({hide:!0})},context:this}}})},a.prototype.saveHotspot=function(a){var b,c;return c=this._scaleDown(this.currentHotspot.sel),b=new arcs.models.Hotspot({resource_id:arcs.resource.id,type:a.type,caption:a.caption,x1:c.x1,x2:c.x2,y1:c.y1,y2:c.y2}),b.save(),this.collection.add(b)},a.prototype._scaleDown=function(a){return a.x1/=this.img.width(),a.y1/=this.img.height(),a.x2/=this.img.width(),a.y2/=this.img.height(),a},a.prototype._scaleUp=function(a){return a.x1*=this.img.width(),a.y1*=this.img.height(),a.x2*=this.img.width(),a.y2*=this.img.height(),a},a.prototype.update=function(){return this.collection.fetch({success:__bind(function(){return this.render()},this)})},a.prototype.render=function(){var a,b,c,d,e,f,g,h;b=$("#hotspots-wrapper"),a=$("#annotations-wrapper"),b.html(""),a.html(""),e={hotspots:[]},h=this.collection.models;for(f=0,g=h.length;f<g;f++)d=h[f],c=this._scaleUp(d.toJSON()),c.left=c.x1,c.width=c.x2-c.x1,c.top=c.y1,c.height=c.y2-c.y1,e.hotspots.push(c);return b.html(Mustache.render(arcs.templates.hotspot,e)),a.html(Mustache.render(arcs.templates.annotation,e))},a}();var __bind=function(a,b){return function(){return a.apply(b,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.views.Resource=function(){function a(){this.keydownDelegate=__bind(this.keydownDelegate,this),a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.el=$("#resource-wrapper"),a.prototype.initialize=function(){return $(document).bind("keydown",this.keydownDelegate),this.model.bind("change",__bind(function(){return this.render},this)),this.model.bind("destroy",__bind(function(){return this.render},this)),arcs.bind("resourceChange",__bind(function(){return arcs.utils.hash.set(this.index+1),this.render()},this)),arcs.discussionView=new arcs.views.Discussion({el:$("#discussion")}),arcs.tagView=new arcs.views.Tag({el:$("#information")}),arcs.hotspotView=new arcs.views.Hotspot({el:$("#resource")}),arcs.toolbarView=new arcs.views.Toolbar({el:$("#toolbar")}),this.index=this.parseHash(),this.setResource(this.index)||this.render(),this.setupCarousel(this.index)},a.prototype.events={"dblclick img":"openFullScreen","click #next-button":"nextResource","click #prev-button":"prevResource"},a.prototype.keydownDelegate=function(a){if(a.keyCode===37)return this.prevResource(),a.preventDefault(),!1;if(a.keyCode===39)return this.nextResource(),a.preventDefault(),!1},a.prototype.setupCarousel=function(a){return $("#carousel").elastislide({imageW:100,current:a,onClick:__bind(function(a){var b;return b=a.find("img").attr("data-id"),this.setResourceById(b)},this)})},a.prototype.openFullScreen=function(){return window.open(this.model.get("url"),"_blank","menubar=no")},a.prototype.nextResource=function(){if(this.collection.length>this.index+1)return this.index+=1,this.swapModel(this.collection.at(this.index)),this.setCarousel(this.index)},a.prototype.prevResource=function(){if(this.index>0)return this.index-=1,this.swapModel(this.collection.at(this.index)),this.setCarousel(this.index)},a.prototype.setResource=function(a){if(this.collection.length>a+1&&a>=0)return this.swapModel(this.collection.at(a)),this.index=a},a.prototype.setResourceById=function(a){return this.swapModel(this.collection.get(a))},a.prototype.setIndex=function(){return this.index=this.collection.indexOf(this.model)},a.prototype.setCarousel=function(a){return $("#carousel").elastislide("slideToIndex",a)},a.prototype.checkNavigation=function(){return this.collection.length===this.index+1?$("#next-button").addClass("disabled"):$("#next-button").removeClass("disabled"),this.index===0?$("#prev-button").addClass("disabled"):$("#prev-button").removeClass("disabled")},a.prototype.swapModel=function(a){return this.model=a,this.setIndex(),arcs.resource=a,arcs.trigger("resourceChange")},a.prototype.setThumbSelected=function(){var a;return a=$("#carousel"),a.find(".thumb").removeClass("selected"),a.find(".thumb[data-id="+this.model.id+"]").addClass("selected")},a.prototype.parseHash=function(){return arcs.utils.hash.get()!=null?arcs.utils.hash.get()-1:0},a.prototype.render=function(){var a,b,c,d;return b=this.el.find("#resource"),c=this.el.find("#resource-details"),a=this.el.find("#collection-details"),b.html(""),d=arcs.utils.mime.getInfo(this.model.get("mime_type")).type,d==="image"?b.html(Mustache.render(arcs.templates.resourceImage,this.model.toJSON())):d==="document"?b.html(Mustache.render(arcs.templates.resourceDocument,this.model.toJSON())):(arcs.log("unknown type"),b.html("Unknown resource type.")),arcs.trigger("resourceLoaded"),c.html(Mustache.render(arcs.templates.resourceTable,this.model.toJSON())),this.collection.length&&a.html(Mustache.render(arcs.templates.collectionTable,arcs.collectionData)),this.checkNavigation(),this.setThumbSelected(),this},a}();var __bind=function(a,b){return function(){return a.apply(b,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.views.Search=function(){function a(){this.keydownDelegate=__bind(this.keydownDelegate,this),a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.initialize=function(){return this.collection=new arcs.collections.ResultSet,$(".btn[rel=tooltip]").tooltip({placement:"bottom"}),this.setupSelect(),this.search=this.setupSearch(),this.doSearch(this.search.searchQuery.toJSON()),$(document).keydown(this.keydownDelegate)},a.prototype.events={"dblclick img":"openResult","click img":"selectResult","click .result":"unselectAll","click #search-results":"unselectAll","click #open-btn":"openSelected","click #open-colview-btn":"makeCollectionFromSelected","click #collection-btn":"makeCollectionFromSelected","click #bookmark-btn":"bookmarkSelected","click #tag-btn":"tagModal","click #grid-btn":"gridView","click #list-btn":"listView"},a.prototype.setupSearch=function(){var a,b;return a=arcs.utils.hash.get()||null,b=VS.init({container:$("#search-wrapper"),query:a||"",callbacks:{search:__bind(function(a,b){return this.doSearch(b.toJSON()),arcs.utils.hash.set(a)},this),facetMatches:function(a){return a(["file-type","sha","user","tag","collection","date"])},valueMatches:function(a,b,c){switch(a){case"file-type":return c(arcs.utils.mime.types());case"user":return c(["Nick Reynolds","Jon Frey","Josh Compton","Joe Archaeologist"])}}}})},a.prototype.setupSelect=function(){return $("#search-results").selectable({distance:20,filter:"img",selecting:function(a,b){return $(b.selecting).parent().addClass("selected")},selected:function(a,b){return $(b.selected).parent().addClass("selected")},unselecting:function(a,b){return $(b.unselecting).parent().removeClass("selected")},unselected:function(a,b){return $(b.unselected).parent().removeClass("selected")}})},a.prototype.doSearch=function(a){return a==null&&(a=null),_.each(a,function(a){return delete a.app}),this.collection.fetch({data:JSON.stringify(a),type:"POST",contentType:"application/json",success:__bind(function(){return this.render()},this),error:function(){return arcs.log("error")}})},a.prototype.keydownDelegate=function(a){if((a.metaKey||a.ctrlKey)&&a.keyCode===65)return this.selectAll(),a.preventDefault()},a.prototype.makeCollectionFromSelected=function(a,b,c){var d,e,f;return a==null&&(a=null),b==null&&(b=null),c==null&&(c=null),f=function(){var a,b,c,d;c=this.getSelected().get(),d=[];for(a=0,b=c.length;a<b;a++)e=c[a],d.push($(e).find("img").attr("data-id"));return d}.call(this),b=b!=null?b:"Temporary collection",c=c!=null?c:"Results from search, '"+arcs.utils.hash.get()+"'",arcs.log(b,c),d={Collection:{title:b,description:c,"public":!1,temporary:!0},Members:f},$.ajax({url:arcs.baseURL+"collections/create",data:JSON.stringify(d),type:"POST",contentType:"application/json",success:__bind(function(a){return window.open(arcs.baseURL+"collection/"+a.id)},this),error:function(){return arcs.log("error")}})},a.prototype.getSelected=function(){return $(".result.selected")},a.prototype.getAll=function(){return $(".result")},a.prototype.unselectAll=function(a){return a==null&&(a=null),a!=null&&(a.metaKey||a.ctrlKey||a.shiftKey)?!1:a!=null&&$(a.target).attr("src")?!1:this.getSelected().removeClass("selected")},a.prototype.selectAll=function(){return this.getAll.addClass("selected")},a.prototype.toggleAll=function(){return this.getAll.toggleClass("selected")},a.prototype.selectResult=function(a){return a.ctrlKey||a.shiftKey||a.metaKey||this.unselectAll(),$(a.currentTarget).parent(".result").toggleClass("selected")},a.prototype.openResult=function(a){var b,c;return arcs.log("called"),a instanceof jQuery.Event?(b=$(a.currentTarget).parent(),a.preventDefault()):b=$(a),c=b.find("img").attr("data-id"),window.open(arcs.baseURL+"resource/"+c)},a.prototype.tagModal=function(){var a,b;a=this.getSelected().length,b=a>1?"s":"";if(a===0){alert("You must select at least 1 result to tag.");return}return arcs.modal({template:arcs.templates.searchModal,templateValues:{title:"Tag Selected",message:""+a+" resource"+b+" will be tagged."},inputs:["search-modal-value"],backdrop:!0,buttons:{save:{callback:this.tagSelected,context:this}}})},a.prototype.tagResult=function(a,b){var c,d;return c=$(a).find("img").attr("data-id"),d=new arcs.models.Tag({resource_id:c,tag:b}),d.save()},a.prototype.tagSelected=function(a,b,c){var d;return c==null&&(c=null),c=c!=null?c:a["search-modal-value"],d=this,this.getSelected().each(function(){return d.tagResult(this,c)})},a.prototype.bookmarkResult=function(a,b){var c,d;return b==null&&(b=null),d=$(a).find("img").attr("data-id"),c=new arcs.models.Bookmark({resource_id:d,description:b}),c.save()},a.prototype.bookmarkSelected=function(){var a;return a=this,this.getSelected().each(function(){return a.bookmarkResult(this)})},a.prototype.openSelected=function(){var a;return a=this,this.getSelected().each(function(){return a.openResult(this)})},a.prototype.gridView=function(){return $("#list-btn").removeClass("active"),$("#grid-btn").addClass("active"),this.render()},a.prototype.listView=function(){var a;return $("#grid-btn").removeClass("active"),$("#list-btn").addClass("active"),this.render(a=!0)},a.prototype.render=function(a){var b;return a==null&&(a=!1),a?b=arcs.templates.resultsList:b=arcs.templates.resultsGrid,$("#search-results").html(Mustache.render(b,{results:this.collection.toJSON()}))},a}();var __bind=function(a,b){return function(){return a.apply(b,arguments)}},__hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};arcs.views.Tag=function(){function a(){this.keydownDelegate=__bind(this.keydownDelegate,this),a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.events={"keydown #new-tag":"keydownDelegate"},a.prototype.initialize=function(){return this.collection=new arcs.collections.TagList,arcs.focusHelper($("#new-tag")),arcs.bind("resourceChange",__bind(function(){return this.update()},this)),_.bindAll(this,"render"),this.collection.bind("add",this.render,this),this.collection.bind("remove",this.render,this),this.update()},a.prototype.keydownDelegate=function(a){if(a.keyCode===13)return this.saveTag(),a.preventDefault(),!1},a.prototype.saveTag=function(){var a,b;return a=this.el.find("input#new-tag"),b=new arcs.models.Tag({resource_id:arcs.resource.id,tag:a.val()}),a.val(""),b.save(),this.collection.add(b)},a.prototype.update=function(){return this.collection.fetch({success:__bind(function(){return this.render()},this)})},a.prototype.render=function(){var a;return a=$("#tags-wrapper"),a.html(Mustache.render(arcs.templates.tagList,{tags:this.collection.toJSON()})),this},a}();var __hasProp=Object.prototype.hasOwnProperty,__extends=function(a,b){function d(){this.constructor=a}for(var c in b)__hasProp.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a},__bind=function(a,b){return function(){return a.apply(b,arguments)}};arcs.views.Toolbar=function(){function a(){a.__super__.constructor.apply(this,arguments)}return __extends(a,Backbone.View),a.prototype.initialize=function(){return arcs.bind("resourceChange",__bind(function(){return this.buttonCheck()},this)),this.addButton({id:"full-res",text:"Full Resolution","class":"image"})},a.prototype.events={"click .btn#full-res":"openFullScreen","click .btn#permalink":"clipboardPermalink","click .btn#split-pdf":"splitPDF","keyup #search":"searchCheck"},a.prototype.openFullScreen=function(){return arcs.resourceView.openFullScreen()},a.prototype.searchCheck=function(a){},a.prototype.clipboardPermalink=function(){},a.prototype.splitPDF=function(){},a.prototype.addButton=function(a){return this.el.find("#nav-container").append(Mustache.render(arcs.templates.button,a))},a.prototype.hasButton=function(a){return this.el.find("#nav-container").children("#"+a).length>0},a.prototype.removeButton=function(a){return this.el.find("#nav-container").children("#"+a).remove()},a.prototype.buttonCheck=function(){return arcs.utils.mime.getInfo(arcs.resource.get("mime_type")).ext==="pdf"?this.addButton({id:"split-pdf",text:"Split PDF","class":"image"}):this.removeButton("split-pdf")},a}();